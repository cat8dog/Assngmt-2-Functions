...
var myActualName:String = "Catherine Reyto"

func returnMyName(myName:String) {
    print("My name is \(myName)")
}

returnMyName(myActualName)
...
func returnMyInfo(firstName fName: String, lastName lName:String, age: Int) -> String {
    
    return ("my name is \(fName) \(lName) and I'm \(age)")

}

var returnedString = returnMyInfo(firstName: "James", lastName:"Larcombe" , 39)
...
//}
//
//hello("Catherine Reyto")

func sayHello(fromName name: String, age: Int, location: String, birthDate: Int, birthMonth: String) {
    println ("My name is \(name), I'm \(age) and from \(location).  My \(age + 1)th birthday is on the \(birthDate) of \(birthMonth)")
}

sayHello(fromName: "Catherine", 33, "Toronto", 16, "August")
...
introduction(name:"Catherine Reyto")
/*:
...
*/
func treeFallingInWoods(isThereSound: String?) {
    if let makesSound = isThereSound {
        println("When a tree falls in the woods and no one is around it goes \(makesSound)")
    } else {
        println ("The tree is silent")
    }
}

treeFallingInWoods("BLAM!!!")
/*:
...
helloWithNames("Catherine", "Cat", "Lisa")

func sayHiWithNames(names: String...) {
    if names.count > 0 {
        for name in names {
            println("Hello, \(name)")
        }
...
//var name2 = "Puppy"
//
//func nameSwap(inoout name1: String, inout name2: String) {
//    let oldName1 = name1
//    name1 = name2
//    name2= oldName1
//}
